...
map <buffer> <F2> :w<CR>:!/usr/bin/env python % <cr>
iab py! #!/usr/bin/env python<cr># -*- coding: utf8 -*-
iab ifname! if __name__ == "__main__":<cr>
iab """! """<cr><cr>"""
iab auth! __author__ = "Pavel Bogomolenko"<cr>__version__ = "0.1"<cr>__status__ = "Development"
